...
function emptyDraft(collection: ContentCollection): Draft {
  if (collection === "certifications") return { id: "", title: emptyLocalized(), subtitle: emptyLocalized(), logo: "", kind: "certification", points: [emptyLocalized(), emptyLocalized(), emptyLocalized(), emptyLocalized()], issuer: emptyLocalized(), obtainedAt: emptyLocalized(), certificateImage: "", verifyUrl: "", featured: false, containedCertificationIds: [], specializationId: "" };
