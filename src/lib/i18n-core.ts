...
export const translations = {
  ...
  en: {
    ...
    common: { back: "Back", all: "All", view: "View", verify: "Verify", readArticle: "Read article", noProjects: "No projects published yet.", noPosts: "No articles published yet.", noCertifications: "No certifications published yet.", allCertifications: "View all certifications", nextProject: "Next project", liveDemo: "Live demo", github: "GitHub" },
    about: { greeting: "Hi, I’m", me: "ME", summary: "I’m passionate about computer science, especially machine learning. I’m also deeply interested in web and mobile development, where technology meets thoughtful design.", certifications: "Professional Certifications", certificationLead: "Continuous learning and professional development through industry-leading bodies.", scrollyKicker: "Experience, skills and information", tabs: { parcours: "Experience", stack: "Stack", infos: "Info" }, experienceLead: "My first experiences across mobile development and data analysis.", cv: "View resume", infoLabels: { base: "Based in", focus: "Focus", availability: "Availability" }, infoValues: { base: "Cotonou, Benin", focus: "Machine learning · Web and mobile development · IT solutions", availability: "Open to collaborations, projects and learning opportunities" } },
    ...
    certifications: { title: "All certifications", description: "Descriptions, topics, dates and visual proof.", specialization: "Specialization", certification: "Certification", points: "Key points", issuer: "Issuer", obtained: "Obtained", viewCertificate: "View certificate", verifyCertification: "Verify certification", verifySpecialization: "Verify specialization", all: "All", empty: "No certification in this category.", courses: "Course certificates", coursesDescription: "Earned after completing each course in the specialization." },
